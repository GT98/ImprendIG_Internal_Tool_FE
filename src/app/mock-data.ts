...
export const CALLS: Call[] = [
  { setterId: null, id: 'c01', sellerId: 'marco',  client: 'Andrea Gallo',      company: 'Logitech Italia',    type: 'demo',      status: 'da-fare', statusCode: null,          statusOptionId: null, value: 8500,  when: atTime(TODAY, 0, 9, 30),  link: 'meet.imprendig.it/a-gallo',    notes: null },
  { setterId: null, id: 'c02', sellerId: 'marco',  client: 'Francesca Neri',    company: 'Sartoria Neri SRL',  type: 'closing',   status: 'da-fare', statusCode: null,          statusOptionId: null, value: 14200, when: atTime(TODAY, 0, 11, 0),  link: 'meet.imprendig.it/f-neri',     notes: null },
  { setterId: null, id: 'c03', sellerId: 'giulia', client: 'Davide Conte',      company: 'ConteBuild SPA',     type: 'follow-up', status: 'fatta',   statusCode: 'si',          statusOptionId: 1,    value: 6200,  when: atTime(TODAY, 0, 10, 0),  link: 'meet.imprendig.it/d-conte',    notes: 'Cliente interessato, inviato preventivo.' },
  { setterId: null, id: 'c04', sellerId: 'luca',   client: 'Martina Greco',     company: 'Greco Pharma',       type: 'demo',      status: 'da-fare', statusCode: null,          statusOptionId: null, value: 9800,  when: atTime(TODAY, 0, 14, 30), link: 'meet.imprendig.it/m-greco',    notes: null },
  { setterId: null, id: 'c05', sellerId: 'sara',   client: 'Paolo Riva',        company: 'Riva Logistica',     type: 'follow-up', status: 'no-show', statusCode: 'no-show',     statusOptionId: 4,    value: 4300,  when: atTime(TODAY, 0, 15, 0),  link: 'meet.imprendig.it/p-riva',     notes: null },
  { setterId: null, id: 'c06', sellerId: 'marco',  client: 'Chiara Fontana',    company: 'Fontana Design',     type: 'demo',      status: 'da-fare', statusCode: null,          statusOptionId: null, value: 5600,  when: atTime(TODAY, 0, 16, 30), link: 'meet.imprendig.it/c-fontana',  notes: null },
  { setterId: null, id: 'c07', sellerId: 'giulia', client: 'Stefano Marini',    company: 'Marini & Co',        type: 'closing',   status: 'da-fare', statusCode: null,          statusOptionId: null, value: 21000, when: atTime(TODAY, 1, 9, 0),   link: 'meet.imprendig.it/s-marini',   notes: null },
  { setterId: null, id: 'c08', sellerId: 'luca',   client: 'Valentina Costa',   company: 'Costa Tessile',      type: 'demo',      status: 'da-fare', statusCode: null,          statusOptionId: null, value: 7400,  when: atTime(TODAY, 1, 11, 30), link: 'meet.imprendig.it/v-costa',    notes: null },
  { setterId: null, id: 'c09', sellerId: 'sara',   client: 'Roberto Esposito',  company: 'Esposito Auto',      type: 'follow-up', status: 'da-fare', statusCode: null,          statusOptionId: null, value: 3900,  when: atTime(TODAY, 1, 14, 0),  link: 'meet.imprendig.it/r-esposito', notes: null },
  { setterId: null, id: 'c10', sellerId: 'marco',  client: 'Giorgia Ricci',     company: 'Ricci Hotels',       type: 'closing',   status: 'da-fare', statusCode: null,          statusOptionId: null, value: 18500, when: atTime(TODAY, 1, 16, 0),  link: 'meet.imprendig.it/g-ricci',    notes: null },
  { setterId: null, id: 'c11', sellerId: 'giulia', client: 'Alessio Moretti',   company: 'Moretti Group',      type: 'demo',      status: 'da-fare', statusCode: null,          statusOptionId: null, value: 11200, when: atTime(TODAY, 2, 10, 30), link: 'meet.imprendig.it/a-moretti',  notes: null },
  { setterId: null, id: 'c12', sellerId: 'luca',   client: 'Federica Galli',    company: 'Galli Food',         type: 'follow-up', status: 'da-fare', statusCode: null,          statusOptionId: null, value: 5100,  when: atTime(TODAY, 2, 15, 30), link: 'meet.imprendig.it/f-galli',    notes: null },
  { setterId: null, id: 'c13', sellerId: 'sara',   client: 'Matteo Rizzo',      company: 'Rizzo Consulting',   type: 'demo',      status: 'da-fare', statusCode: null,          statusOptionId: null, value: 6700,  when: atTime(TODAY, 3, 9, 30),  link: 'meet.imprendig.it/m-rizzo',    notes: null },
  { setterId: null, id: 'c14', sellerId: 'marco',  client: 'Elisa Barbieri',    company: 'Barbieri Pharma',    type: 'closing',   status: 'da-fare', statusCode: null,          statusOptionId: null, value: 16800, when: atTime(TODAY, 3, 11, 0),  link: 'meet.imprendig.it/e-barbieri', notes: null },
  { setterId: null, id: 'c15', sellerId: 'marco',  client: 'Simone Ferro',      company: 'Ferro Industrie',    type: 'closing',   status: 'fatta',   statusCode: 'si',          statusOptionId: 1,    value: 24500, when: atTime(TODAY, -1, 10, 0), link: '', notes: 'Contratto firmato.' },
  { setterId: null, id: 'c16', sellerId: 'giulia', client: 'Laura De Luca',     company: 'De Luca Studio',     type: 'demo',      status: 'fatta',   statusCode: 'ci-pensa',    statusOptionId: 7,    value: 7800,  when: atTime(TODAY, -1, 14, 0), link: '', notes: 'Ricontattare la settimana prossima.' },
  { setterId: null, id: 'c17', sellerId: 'luca',   client: 'Nicola Santoro',    company: 'Santoro Energia',    type: 'follow-up', status: 'no-show', statusCode: 'no-show',     statusOptionId: 4,    value: 9200,  when: atTime(TODAY, -1, 16, 0), link: '', notes: null },
  { setterId: null, id: 'c18', sellerId: 'sara',   client: 'Beatrice Lombardi', company: 'Lombardi Retail',    type: 'closing',   status: 'fatta',   statusCode: 'no',          statusOptionId: 2,    value: 13400, when: atTime(TODAY, -2, 11, 0), link: '', notes: 'Budget non sufficiente per il piano enterprise.' },
];
