...
const ICONS: Record<string, string | string[]> = {
  ...
  eyeOff:        ['M17.94 17.94A10.07 10.07 0 0112 20c-7 0-11-8-11-8a18.45 18.45 0 015.06-5.94M9.9 4.24A9.12 9.12 0 0112 4c7 0 11 8 11 8a18.5 18.5 0 01-2.16 3.19', 'M1 1l22 22'],
  info:          ['M12 22a10 10 0 100-20 10 10 0 000 20z', 'M12 8h.01', 'M12 12v5'],
  mic:           ['M12 2a3 3 0 013 3v7a3 3 0 01-6 0V5a3 3 0 013-3z', 'M19 10v2a7 7 0 01-14 0v-2', 'M12 19v3', 'M8 22h8'],
  play:          'M8 5l11 7-11 7V5z',
  pause:         ['M6 4h4v16H6z', 'M14 4h4v16h-4z'],
  micOff:        ['M1 1l22 22', 'M9 9v3a3 3 0 005.12 2.12M15 9.34V5a3 3 0 00-5.94-.6', 'M17 16.95A7 7 0 015 12v-2m14 0v2a7 7 0 01-.11 1.23', 'M12 19v3', 'M8 22h8'],
};
